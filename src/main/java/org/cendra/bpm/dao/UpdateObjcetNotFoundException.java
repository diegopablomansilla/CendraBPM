...
public class UpdateObjcetNotFoundException extends IllegalArgumentException {
	...
	public UpdateObjcetNotFoundException() {
		super("Se intento actualizar un objeto que no existe en la base de datos.");
	}
	
	public UpdateObjcetNotFoundException(String condition) {
		super("Se intento actualizar un objeto que no existe en la base de datos. Condición de búsqueda: " + condition);
	}
